    ...
    ui(new Ui::Report)
{
    ...
    ui->comboBox_3->addItem("2015");
    ui->comboBox_3->addItem("2016");

    ui->comboBox_2->addItem("Malaria");
    ui->comboBox_2->addItem("Typhoid");
    ui->comboBox_2->addItem("HIV/Aids");
    ui->comboBox_2->addItem("Syphilis");
